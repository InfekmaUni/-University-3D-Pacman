...
namespace OpenGL_Game.Scenes
{
    class MenuScene : Scene
    {
        ...
        Pacman player;
        public static MenuScene menuInstance;
        ...
        private void CreateSystems()
        {
            ...
            systemManager.AddUpdateSystem(newUpdateSystem = new SystemAudio(entityManager.Entities()));
        }
        private void CreateEntities()
        {
            entityManager.AddEntity(new UIScreen(new Vector2(SceneManager.WindowWidth, SceneManager.WindowHeight)));
            entityManager.AddEntity(new Sound("menu-background.wav", true, true));
            CreateMenuButtons();
        }
        ...
        private void CreateMenuButtons()
        {
            ...
            Button but = new Button("UI-Play", center - (buttonSize/2), buttonSize, "Play");
            but.buttonEvent = PlayGame;
            buttons.Add(but);
            ...
            entityManager.AddEntity(new Text("Main Menu", 16, new Vector3(center.X, 20, 0),true));
        ...
        public override void Update(FrameEventArgs e)
        {
            ...
            if (GameKeyboard.IsKeyDown(Key.Space))
            {
                PlayGame();
            }
        ...
        {
            sceneManager.NewScene(new MyGame(sceneManager));
        }
