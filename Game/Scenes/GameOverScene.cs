...
namespace OpenGL_Game.Scenes
{
    ...
    class GameOverScene : Scene
    {
        ...
        Pacman player;
        public static GameOverScene menuInstance;
        EventArgs e;

        int total_score = 0;
        public GameOverScene(SceneManager sceneManager, int score)
            : base(sceneManager)
        {
        ...
        private void CreateMenuButtons()
        {
            ...
            Button but = new Button("UI-Play", center - (buttonSize/2), buttonSize, "MainMenu");
            but.buttonEvent = MainMenu;
            buttons.Add(but);
            ...
            entityManager.AddEntity(new Text("Game Over - your score is " + total_score, 16, new Vector3(center.X, 20, 0),true));
        ...
        {
            sceneManager.NewScene(new MenuScene(sceneManager));
        }
